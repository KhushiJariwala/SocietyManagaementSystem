...
if($_SERVER['REQUEST_METHOD'] == "POST"){
	...
	if(!empty($_POST['edit_id'])){
		$sql = "UPDATE `serviceprovider` SET `name` = '".$_POST['title']."' , `image` = '".$file."' WHERE id = '".$_POST['edit_id']."' ";
		$mysqli->query($sql);
		$_SESSION['success'] = "Service Provider Update successfully.";
	}else{
		$sql = "INSERT INTO `serviceprovider` (`name`, `image`) VALUES ('".$_POST['title']."', '".$file."')";
		$mysqli->query($sql);
		$_SESSION['success'] = "Service Provider Insert successfully.";
	}
    header("location:".$base_url."ServiceProvider.php");die;
}
...
if($id){
	$sql = "SELECT * FROM serviceprovider WHERE id = '".$id."'" ;
	$data = array(); 
...
<div class="row">
	<div class="col-12">
		<h2>Service Provider Manager</h2>
